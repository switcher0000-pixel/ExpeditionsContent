    ...
    public class PhotoAlbum : ModTile
    {
        ...
        public override void KillTile(int i, int j, ref bool fail, ref bool effectOnly, ref bool noItem)
        {
            try
            {
                ...
                style += styleWrapLimit * t.TileFrameY / 18;
                // Main.NewText("xys: " + t.TileFrameX + ", " + t.TileFrameY + ", " + style);
                ...
                Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16, 16, 16, itemToDrop);
            }
            catch { }
        }
    }
